...
<script lang="ts">
    ...
    $: {
        ...
        } else if (timeInteger > 280 && timeInteger <= 300) {
            locationMeganChaotic = "F";
        }
    }
    
    // alll of the characters possible dialogue
    const dialogueMeganChaoticAll = 
        [[ // showroom back
            ["What are you up to? Something productive, I hope!",
             "Everyone needs to make sure they are always giving it their all. One hundred and ten percent!"
            ]
        ], [ // kitchen dialoge
            ["Do you know how to work the espresso machine? You used to be a barista, right?",
            ...
            ["Obviously Bran and I didn't arrive together today, so, well, I still need my coffee.",
            ]
        ], 
        [ // showroom (front) dialogue
            ["It's not so easy managing our creative brand you know.",
            ...
            ["Creatively, the Julliard brand should say 'Luxury' but also 'Salt of the earth'. And it should say 'Timeless' but also feel really, really 2018.",
        ...
        [ // responding to the flower moving megan keebler task, and initiating flower arraning task.
            ["Did you move the flower stack in the northeast corner?",
        ...
        [ // responding to the flower arranging speech check task (a good and a bad)
          // good
            ["Oh great! Haha, there's hope for you yet. This is a great arrangement. Maybe I can come to one of your outbounds sometime and do florals for the dispay.",
             "You are such a great coworker and such a great listener! I love hanging out, girly!"
            ],
          // bad
            ["I don't really know what I expected, so I guess it's not a let down. You might as well just throw them away.",
    ...
    $: {
        ...
        if (locationMeganChaotic = "G") {
            dialogueMeganChaoticSecondary = dialogueMeganChaoticAll[0][0] // only has secondary here
        // kitchen
        } else if (locationMeganChaotic = "H") {
            dialogueMeganChaoticMain = dialogueMeganChaoticAll[1][0]
            dialogueMeganChaoticSecondary = dialogueMeganChaoticAll[1][1]
        // showroom front
        } else if (locationMeganChaotic = "F") { 
            dialogueMeganChaoticMain = dialogueMeganChaoticAll[2][0]
            dialogueMeganChaoticSecondary = dialogueMeganChaoticAll[2][1]
        ...
        // 10:00am to 1pm, Brans Upstairs
            ...
            dialogueMeganChaoticSecondary = dialogueMeganChaoticAll[dialogueMeganChaoticAll.length - 1][0]
        }
    }
