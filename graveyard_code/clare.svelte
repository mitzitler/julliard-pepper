...
<script>
    ...
    let locationClare = "";
    $: {
        // 10am to 11am, or minute 0 to minute 60
        if (timeInteger <= 60) {
            locationClare = "A";
    ...
    const dialogueAllClare = 
        {"A" : { // parking lot dialogue, dialogueAllClare[0]
            ...
            ["Hey! Glad to see you got my message to get here at 10 instead of 9 today - you are exactly on time",
             ...
             ["Actually, you know what would be nice? Find Bran and say hi and good luck! I'm sure he will appreciate it.", "clare-1"]   
            ],
            "secondary" : 
        ...
        "G" : { // showroom dialogue, dialogueAllClare[1]
            ...
            ["Guess what?",
             ...
             ["Will you stamp all the bags in this box? The stamp pad is somewhere upstairs I think.", "clare-2"],
    ...
    $: {
        ...
        if (timeInteger <= 60 && locationClare == "A") {
            dialogueClareMain = dialogueAllClare["A"]["task"] // initiates clareTask 1
            dialogueClareSecondary = dialogueAllClare["A"]["secondary"]
        // 11:10 am to 2pm, and in the showroom
        } else if (locationClare == "G") {
            dialogueClareMain = dialogueAllClare["G"]["task"] // initiates clareTask 2
